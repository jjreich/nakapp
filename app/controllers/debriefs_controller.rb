class DebriefsController < ApplicationController
  ...
  private
    ...
    def debrief_params
      params.require(:debrief).permit(:flightNumber, :preparation_rating, :preparationComments, :cateringStatus, :catering_rating, :cateringComments, :clientArrivalTiming, :clientArrivalType, :clientArrivalComments, :flightTurbulence, :airborneFlightDelays, :airborneFlightCheckins, :flightComments, :clientDepartureType, :clientDepartureComments, :overallComments, :user_id, :flight_id, :client_arrival_rating, :airborne_rating, :client_departure_rating, :maintenance_rating, :maintenance_check, :maintenance_comments, :finish_later)
    end
end
