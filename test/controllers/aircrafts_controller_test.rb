...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference('Aircraft.count') do
      post aircrafts_url, params: { aircraft: { tailNumber: @aircraft.tailNumber, type: @aircraft.type } }
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { tailNumber: @aircraft.tailNumber, type: @aircraft.type } }
